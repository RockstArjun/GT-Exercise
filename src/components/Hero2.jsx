    ...
    <>
      ...
      <div class="chr-1vlw1q7 e1mt1zi0">
          ...
          <div class="chr-0 ey4tj182">
            ...
            <div class="chr-165xq35 ey4tj183">
              ...
              <a href="/" class="e1ja7avb2 chr-5216lu e1ja7avb1">
                <span class="chr-1xdhyk6 e1ja7avb3">components and pages</span>
              </a>
        ...
        <div class="chr-6c3x63 ey4tj180">
          ...
          <div class="chr-0 ey4tj182">
            <div class="chr-zxo0lx ey4tj184">Mock hard to reach use cases</div>
            <div class="chr-165xq35 ey4tj183">
        ...
        <div class="chr-6c3x63 ey4tj180">
          ...
          <div class="chr-0 ey4tj182">
            ...
            <div class="chr-165xq35 ey4tj183">
              ...
              to customize your workflow, automate testing, and integrate with
              your favorite tools.
            </div>
          </div>
        </div>
        ...
        <div class="chr-1hkuxdi exvta3d1">
          <div class="chr-13bwum6 exvta3d10">
            <span>
              ...
              allows teams to design, build, and organize UI components (and
              even full screens!) without getting tripped up over business logic
              and plumbing.”
            </span>
          </div>
          <div class="chr-1vcob1d exvta3d4">
            <div class="chr-s5xdrg exvta3d6">
              ...
              <div class="chr-1a2afmv exvta3d7">
                ...
                <div class="chr-psji7g exvta3d8">Author of Atomic Design</div>
              </div>
            </div>
      ...
      <div class="chr-xb312e e1rcwf4f3">
        ...
        <div orientation="right" class="chr-18b67rp ecg98e20">
          <div class="chr-dqmn0x ecg98e21">
            ...
            <div class="chr-1ppjfgp ecg98e22">
              Stories are a pragmatic, reproducible way to keep track of UI edge
              cases. Write stories once then reuse them to power automated
              tests.
            </div>
          </div>
          <div class="chr-n48rgu ecg98e24">
        ...
        <div class="chr-1vlw1q7 e1mt1zi0">
          ...
          <div class="chr-6c3x63 ey4tj180">
            ...
            <div class="chr-0 ey4tj182">
              <div class="chr-zxo0lx ey4tj184">Interaction test behavior</div>
              <div class="chr-165xq35 ey4tj183">
                Verify interactions by simulating
                <a href="/" class="e1ja7avb2 chr-5216lu e1ja7avb1">
                  <span class="chr-1xdhyk6 e1ja7avb3">user behavior</span>
                </a>
                . Debug visually alongside your story. Integrates with Testing
                Library.
              </div>
            </div>
          </div>
        ...
        <div class="chr-0 exvta3d0">
          ...
          <div class="chr-1hkuxdi exvta3d1">
            <div class="chr-13bwum6 exvta3d10">
              <span>
                “The tool we use for editing UI is Storybook. It is the perfect
                place to make sure your work aligns with designs to the pixel
                across breakpoints.”
              </span>
            </div>
            <div class="chr-1vcob1d exvta3d4">
