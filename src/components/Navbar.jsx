...
function Navbar() {
  return (
    <nav class="glowTouch-1b4tlcu ex9z48e1">
      <div class="glowTouch-1jqf4gi ex9z48e2">
        <div class="glowTouch-ww6o6b ex9z48e0">
          <div class="glowTouch-g4w1a7 e154td7m0">
            <a
              aria-current="page"
              class="elj7lvw0 glowTouch-1lzd12e e1ja7avb2"
              href="/"
            >
        ...
        <div class="glowTouch-11swlbp ex9z48e0">
          <div class="glowTouch-1a1l4kv e154td7m0">
            <a href="/" class="e1q6bakl0 glowTouch-h3nff7 e1ja7avb2">
              <span class="glowTouch-1xdhyk6 e1ja7avb3">Showcase</span>
            </a>
          </div>
          <div class="glowTouch-1a1l4kv e154td7m0">
            <a class="e1q6bakl0 glowTouch-h3nff7 e1ja7avb2" href="/">
              <span class="glowTouch-1xdhyk6 e1ja7avb3">Docs</span>
            </a>
          </div>
          <div class="glowTouch-1a1l4kv e154td7m0">
            <a href="/" class="e1q6bakl0 e1ja7avb2 glowTouch-1n0n9qo e1ja7avb1">
              <span class="glowTouch-1xdhyk6 e1ja7avb3">Tutorials</span>
            </a>
          </div>
          <div class="glowTouch-1a1l4kv e154td7m0">
            <a class="e1q6bakl0 glowTouch-h3nff7 e1ja7avb2" href="/">
              <span class="glowTouch-1xdhyk6 e1ja7avb3">Addons</span>
            </a>
          </div>
          <div class="glowTouch-1a1l4kv e154td7m0">
            <span
          ...
          <div class="glowTouchomatic-ignore enx0fv32 glowTouch-10gvw3t e154td7m0">
            <div class="glowTouch-7dkk8d enx0fv33">
              <span class="github-btn glowTouch-bx220u elj7lvw1">
          ...
          <div class="glowTouch-1n0pifq e154td7m0">
            <span
              role="button"
              trigger="click"
              class="glowTouch-q99zvx enx0fv31"
              aria-controls="55cff831-941b-490d-af49-3c1460c6202b"
              tabindex="0"
            >
              <button class="enx0fv30 e1ja7avb2 glowTouch-1pgooyc e1ja7avb0">
                <span class="glowTouch-1xdhyk6 e1ja7avb3">
                  <svg
                    viewBox="0 0 1024 1024"
                    width="20px"
